...
import {QThemeMetaData} from "../../../src/model/metaData/QThemeMetaData";

describe("QThemeMetaData", () =>
{
   describe("constructor", () =>
   {
      it("should construct with all properties from object", () =>
      {
         const theme = new QThemeMetaData({
            primaryColor: "#FF0000",
   ...
   describe("density type", () =>
   {
      ...
      {
         const theme = new QThemeMetaData({density: "compact"});
         expect(theme.density).toBe("compact");
      });

      it("should accept normal density", () =>
      {
         const theme = new QThemeMetaData({density: "normal"});
         expect(theme.density).toBe("normal");
      });

      it("should accept comfortable density", () =>
      {
         const theme = new QThemeMetaData({density: "comfortable"});
   ...
   describe("iconStyle type", () =>
   {
      ...
      {
         const theme = new QThemeMetaData({iconStyle: "filled"});
         expect(theme.iconStyle).toBe("filled");
      });

      it("should accept outlined iconStyle", () =>
      {
         const theme = new QThemeMetaData({iconStyle: "outlined"});
         expect(theme.iconStyle).toBe("outlined");
      });

      it("should accept rounded iconStyle", () =>
      {
         const theme = new QThemeMetaData({iconStyle: "rounded"});
         expect(theme.iconStyle).toBe("rounded");
      });

      it("should accept sharp iconStyle", () =>
      {
         const theme = new QThemeMetaData({iconStyle: "sharp"});
         expect(theme.iconStyle).toBe("sharp");
      });

      it("should accept two-tone iconStyle", () =>
      {
         const theme = new QThemeMetaData({iconStyle: "two-tone"});
   ...
   describe("customCss", () =>
   {
      it("should handle multi-line CSS", () =>
      {
         ...
         `;
         const theme = new QThemeMetaData({customCss: css});
